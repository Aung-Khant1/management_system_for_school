...
@section('navs')
	...
	<li class="breadcrumb-item"><a href="{{url()->current()}}"> Students </a></li>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{route('removereq', [$room->id,$student->id])}}" class="btn btn-danger removestud">Remove</a>
									{{-- <button class="btn btn-danger removestud" data-rid={{$room->id}} data-uid={{$student->id}}>Remove</button> --}}
								</td>
							</tr>
							@php $i++ @endphp
							@endforeach
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		$('.removestud').click(function(event) {
