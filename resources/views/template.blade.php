...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="@yield('user_photo')" alt="User Image" width="60" height="60">
        <div>
          <p class="app-sidebar__user-name"> @yield('user_name') </p>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> @yield('sub_title') </h1>
